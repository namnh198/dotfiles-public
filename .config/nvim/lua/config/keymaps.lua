...
-- Split windows
map("n", "ss", ":split<Return>", { desc = "split horizontal", noremap = true, silent = true })
map("n", "sv", ":vsplit<Return>", { desc = "split vertical", noremap = true, silent = true })
...
end, { desc = "copy absolute path", remap = true, silent = true })
